    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.planButton,
        {
          ...
          [sty.planButtoncolor_clear]: hasVariant($state, "color", "clear"),
          [sty.planButtoncolor_green]: hasVariant($state, "color", "green"),
          [sty.planButtoncolor_link]: hasVariant($state, "color", "link"),
          [sty.planButtoncolor_red]: hasVariant($state, "color", "red"),
          [sty.planButtoncolor_sand]: hasVariant($state, "color", "sand"),
          [sty.planButtoncolor_softBlue]: hasVariant(
            $state,
            "color",
            "softBlue"
          ),
          [sty.planButtoncolor_softGreen]: hasVariant(
            $state,
            "color",
            "softGreen"
          ),
          [sty.planButtoncolor_softRed]: hasVariant($state, "color", "softRed"),
          [sty.planButtoncolor_softSand]: hasVariant(
            $state,
            "color",
            "softSand"
          ),
          [sty.planButtoncolor_softYellow]: hasVariant(
            $state,
            "color",
            "softYellow"
          ),
          [sty.planButtoncolor_white]: hasVariant($state, "color", "white"),
          [sty.planButtoncolor_yellow]: hasVariant($state, "color", "yellow"),
          [sty.planButtonisDisabled]: hasVariant(
            $state,
            "isDisabled",
            "isDisabled"
          ),
          [sty.planButtonshape_round]: hasVariant($state, "shape", "round"),
          [sty.planButtonshape_round_size_compact]:
            hasVariant($state, "shape", "round") &&
            hasVariant($state, "size", "compact"),
          [sty.planButtonshape_rounded]: hasVariant($state, "shape", "rounded"),
          [sty.planButtonshape_rounded_showStartIcon]:
            hasVariant($state, "shape", "rounded") &&
            hasVariant($state, "showStartIcon", "showStartIcon"),
          [sty.planButtonshape_rounded_size_compact]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "shape", "rounded"),
          [sty.planButtonshape_sharp]: hasVariant($state, "shape", "sharp"),
          [sty.planButtonshowEndIcon]: hasVariant(
            $state,
            "showEndIcon",
            "showEndIcon"
          ),
          [sty.planButtonshowEndIcon_shape_rounded]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "shape", "rounded"),
          [sty.planButtonshowEndIcon_size_compact]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "showEndIcon", "showEndIcon"),
          [sty.planButtonshowEndIcon_size_compact_showStartIcon]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "showStartIcon", "showStartIcon") &&
            hasVariant($state, "showEndIcon", "showEndIcon"),
          [sty.planButtonshowStartIcon]: hasVariant(
            $state,
            "showStartIcon",
            "showStartIcon"
          ),
          [sty.planButtonsize_compact]: hasVariant($state, "size", "compact"),
          [sty.planButtonsize_compact_showStartIcon]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "showStartIcon", "showStartIcon"),
          [sty.planButtonsize_minimal]: hasVariant($state, "size", "minimal"),
          [sty.planButtonsize_minimal_color_link]:
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__w1FNc)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___6EcJz)}
                role={"img"}
              />
            ),
