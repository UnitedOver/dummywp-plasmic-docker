...
import sty from "./PlasmicPoliciesComponent.module.css"; // plasmic-import: p_biNdkGhZq5/css
import Icon9Icon from "./icons/PlasmicIcon__Icon9"; // plasmic-import: eG81i3pUn5Ov/icon

createPlasmicElementProxy;

export const PlasmicPoliciesComponent__VariantProps = new Array();

export const PlasmicPoliciesComponent__ArgProps = new Array(
  "contentsSlot",
  "heading"
);
...
function PlasmicPoliciesComponent__RenderFunc(props) {
  const { variants, overrides, forNode } = props;
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          heading: "enter text as props"
        },
        Object.fromEntries(
  ...
  return (
    ...
    >
      <div
        data-plasmic-name={"policiesContainer"}
        data-plasmic-override={overrides.policiesContainer}
        className={classNames(projectcss.all, sty.policiesContainer)}
      >
        <Icon9Icon
        ...
        <div
          ...
          className={classNames(
            ...
            sty.text,
            hasVariant(globalVariants, "screen", "bp801")
              ? "policies-title"
              : undefined
          )}
        >
      ...
      >
        <div
          data-plasmic-name={"arrowWrapper"}
          data-plasmic-override={overrides.arrowWrapper}
          className={classNames(projectcss.all, sty.arrowWrapper)}
        >
          <div
          ...
          <PlasmicImg__
            data-plasmic-name={"arrowSvg2"}
            data-plasmic-override={overrides.arrowSvg2}
            alt={""}
            className={classNames(sty.arrowSvg2)}
            displayHeight={"60px"}
            ...
            loading={"lazy"}
            src={{
              src: "data:image/svg+xml;base64,",
              fullWidth: 38.932,
              fullHeight: 60,
              aspectRatio: 0.648867
            }}
          />
        </div>
        {renderPlasmicSlot({
          ...
          value: args.contentsSlot
        })}
        <div
          data-plasmic-name={"blankBox"}
          data-plasmic-override={overrides.blankBox}
          className={classNames(projectcss.all, sty.blankBox)}
        />
      </div>
      <Embed
        ...
        code={
          "<style>\r\n  .policies-title{\r\n    font-size:calc(28px + 14 * ((100vw - 320px)/ 480));\r\n  }\r\n</style>"
        }
      />
    </section>
  );
...
const PlasmicDescendants = {
  ...
  policiesContainer: ["policiesContainer", "svg", "text"],
  svg: ["svg"],
  text: ["text"],
  contents: ["contents", "arrowWrapper", "freeBox", "arrowSvg2", "blankBox"],
  arrowWrapper: ["arrowWrapper", "freeBox", "arrowSvg2"],
  freeBox: ["freeBox"],
  arrowSvg2: ["arrowSvg2"],
  blankBox: ["blankBox"],
  embedHtml: ["embedHtml"]
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicPoliciesComponent__ArgProps,
          internalVariantPropNames: PlasmicPoliciesComponent__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicPoliciesComponent__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicPoliciesComponent";
  } else {
    func.displayName = `PlasmicPoliciesComponent.${nodeName}`;
  }
  return func;
}

export const PlasmicPoliciesComponent = Object.assign(
  // Top-level PlasmicPoliciesComponent renders the root element
  makeNodeComponent("root"),
  {
    // Helper components rendering sub-elements
    policiesContainer: makeNodeComponent("policiesContainer"),
    svg: makeNodeComponent("svg"),
    text: makeNodeComponent("text"),
    contents: makeNodeComponent("contents"),
    arrowWrapper: makeNodeComponent("arrowWrapper"),
    freeBox: makeNodeComponent("freeBox"),
    arrowSvg2: makeNodeComponent("arrowSvg2"),
    blankBox: makeNodeComponent("blankBox"),
    embedHtml: makeNodeComponent("embedHtml"),
    // Metadata about props expected for PlasmicPoliciesComponent
    internalVariantProps: PlasmicPoliciesComponent__VariantProps,
    internalArgProps: PlasmicPoliciesComponent__ArgProps
  }
);

export default PlasmicPoliciesComponent;
/* prettier-ignore-end */
